...
public class Agent {
    ...
    private int activeEnquiryCount;
    ...
    @Enumerated(EnumType.STRING)
    @CollectionTable(name = "agent_languages")
    ...
    public Agent(String n, Set<Language> l, Set<Skill> s, int c) {
        name = n;
        languages = l;
        skills = s;
        maxCapacity = c;
    ...
    public int getActiveEnquiryCount() {
        return activeEnquiryCount;
    }
